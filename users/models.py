...
class User(AbstractUser):
    ...
    phone_number = models.CharField(validators=[validate_phone_number], max_length=17, blank=True)  # Номер телефону користувача
...
class DriverLicenseVerification(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='license_verifications')  # Зв'язок із користувачем
