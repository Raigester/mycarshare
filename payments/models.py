...
class LiqPayPayment(models.Model):
    ...
    payment = models.OneToOneField(Payment, on_delete=models.CASCADE, related_name='liqpay_details')  # Зв'язок до моделі Payment
...
class PaymentTransaction(models.Model):
    ...
    payment = models.ForeignKey(Payment, on_delete=models.SET_NULL, null=True, blank=True, related_name='transactions')  # Пов'язаний платіж
